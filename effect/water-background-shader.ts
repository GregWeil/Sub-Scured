...
void main() {
  ...
  float noise2 = psrdnoise((worldPos + 0.2 * offset) * 0.1, vec2(0.0, 0.0), Time + 10.0, unused);
  float noise3 = psrdnoise((worldPos + 0.1 * offset) * 0.4, vec2(0.0, 0.0), Time + 100.0, unused);
  float noiseg = psrdnoise((worldPos + 0.3 * offset) * 0.4, vec2(0.0, 0.0), Time + 1000.0, unused);
